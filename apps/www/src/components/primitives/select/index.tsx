  ...
  <SelectPrimitive.Trigger
    ...
    className={cn(
      `flex h-10 w-full items-center justify-between rounded-md border bg-transparent px-3 py-2 text-sm 
       ring-offset-primary-50 placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500 
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      `relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none 
       focus:bg-primary-50 focus:text-gray-800 data-[disabled]:pointer-events-none data-[disabled]:opacity-50`,
      className
    )}
    {...props}
  >
