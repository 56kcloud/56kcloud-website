  ...
  return (
    <div className='relative overflow-hidden pt-28 isolate'>
      <div
        ...
        <Image
          className='absolute -top-80 -right-60 sm:-top-60 lg:-top-[400px] sm:-right-40 lg:-right-[600px] opacity-80 \
          min-w-[1000px] sm:min-w-[1000px] lg:min-w-[1500px] h-auto -z-10'
          src={gradientHero}
          alt=''
          width={530}
          height={530}
