        ...
        <div className='mt-11'>
          <div className='grid grid-cols-1 gap-12 lg:gap-6 lg:grid-cols-3'>
            {props.features?.map((feature, index) => (
              <div
                key={index}
                className='relative w-full h-full flex flex-col pt-12 p-6 border border-slate-800 rounded-3xl bg-gradient-to-t from-slate-800 to-slate-900 sm:pt-12 sm:p-8'
              >
