...
export type PricingThreeColumnsProps = {
  title: string
  subtitle: string
  tiers: Array<Tier>
...
const TierCard = ({number, name, description, badge, items}: Tier & {number: number}) => {
  return (
    <div
...
export default function PricingThreeColumns(props: PricingThreeColumnsProps) {
  return (
