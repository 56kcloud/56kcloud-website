...
const ProcessStep = ({
  ...
  return (
    <div className="relative flex flex-col border border-slate-800 rounded-3xl w-full h-full
      ...
      <div className='inline-block self-start rounded-full px-4 py-1 text-white font-medium mb-4 border'>
        {badge}
      </div>
