...
const navigation = {
  ...
  social: [
    {
      name: "Twitter",
      href: "https://twitter.com/edeltech121",
      icon: (props) => (
    ...
    {
      name: "GitHub",
      href: "https://github.com/edeltech",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "Linkedin",
      href: "https://www.linkedin.com/company/edeltech/",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          ...
          {navigation.main.map((item) => (
            <div key={item.name} className="px-5 py-2">
              <Link href={item.href}>
                <a
                  href={item.href}
                  className="text-gray-100 text-base font-semibold uppercase"
                >
                  {item.name}
                </a>
              </Link>
