...
export const darkIllustrationCardsHome: Array<CardPropsImpl> = [
  {
    number: '01',
...
export const lightIllustrationCardsHome: Array<CardPropsImpl> = [
  {
    number: '04',
...
export const lightIllustrationCardsPartners: Array<CardPropsImpl> = [
  {
    number: '01',
    image: '/images/automation.png',
    icon: '/images/cloud-icon.png',
