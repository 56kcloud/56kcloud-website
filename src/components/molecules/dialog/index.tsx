  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        'fixed z-50 grid w-full gap-4 rounded-b-lg border bg-white p-6 shadow-lg \
         animate-in data-[state=open]:fade-in-90 data-[state=open]:slide-in-from-bottom-10 sm:max-w-lg \
    ...
    >
      ...
      <DialogPrimitive.Close
        className='absolute p-1 right-3 top-3 rounded-sm opacity-70 focus:ring-offset-primary-900 \
